frappe.listview_settings['Transit Issue'] = {
    onload(listview) {
        ...
        {
            route_options = {
				"workflow_state": ["=",'Requested for More Details by Supply Team,Pending for confirmation with the Transit complaint Registration Team,Rejected by Transit complaint Registration Team']
			};
        }
